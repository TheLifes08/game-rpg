//
// Created by rkolovanov on 31.10.22.
//
...
namespace Engine::Core
{
  ...
  Cell& Map::get(size_t x, size_t y)
  {
  ...
  Cell& Map::get(double x, double y)
  {
  ...
  std::vector<Engine::Core::Object>& Map::getObjects()
  {
    return m_objects;
  }

  /*bool Map::loadMap(std::istream& dataStream)
  {
    try
    {
  ...
  Engine::Common::Size Map::getSize()
  {
    return m_size;
  }

  Map::MapRow::MapRow(size_t size)
  {
    row.resize(size);
  }
}